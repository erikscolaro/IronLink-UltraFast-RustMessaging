...
pub trait Crud<T, Id> {
    ...
    async fn read(&self, id: Id) -> Result<T, sqlx::Error>;
...
impl Crud<User, IdType> for UserRepository {
    ...
    async fn read(&self, id: IdType) -> Result<User, Error> {
        todo!()
    }
...
impl Crud<Message, IdType> for MessageRepository {
    ...
    async fn read(&self, id: IdType) -> Result<Message, Error> {
        todo!()
    }
...
impl Crud<UserChatMetadata, IdType> for UserChatMetadataRepository {
    ...
    async fn read(&self, id: IdType) -> Result<UserChatMetadata, Error> {
        todo!()
    }
...
impl Crud<Invitation, IdType> for InvitationRepository {
    ...
    async fn read(&self, id: IdType) -> Result<Invitation, Error> {
        todo!()
    }
...
impl Crud<Chat, IdType> for ChatRepository {
    ...
    async fn read(&self, id: IdType) -> Result<Chat, Error> {
        todo!()
    }
...
mod tests {
    ...
    mod user_repo {
		...
		*/
        ...
        #[sqlx::test(migrations = "./migrations", fixtures(path="../fixtures", scripts("popolate_users")))]
        async fn test_create_user(pool: PoolType) -> sqlx::Result<()> {
            
            // effettuo l'azione
            sqlx::query_as!(User, "INSERT INTO users (id, name) VALUES (?, ?)", 1, "Alice")
                .execute(&pool)
                .await?;
